            ...
            <div>
                <div className='mx-auto max-w-7xl sm:px-6 px-4 relative flex justify-between items-center h-screen md:h-screen overflow-hidden'>
                    <div className='relative z-2 lg:max-w-[512px] max-w-[388px]'>
                        <div className='text-[12px] font-bold leading-[16px] tracking-[0.3em] mb-5 text-p3 uppercase text-p3 text-black'>Twenty One Coffee & Eatery</div>
                        ...
                        <Link href='' className='px-6 py-3 text-white bg-black rounded-sm text-lg'>
                            <span>Order now</span>
                        </Link>
